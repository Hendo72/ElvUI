...
L["Primary Unit"] = "Unidade Primária"
L["Requires the unit to be the primary target to display."] = "Requer que a unidade seja o alvo primario para ser exibido."
L["Pet Specific"] = "Especifico para Mascote"
L["Use the profile specific filter Aura Indicator (Pet) instead of the global filter Aura Indicator."] = "Use o filtro especifico de perfil Aura Indicator (Pet) ao invés do filtro global Aura Indicator."
L["%s and then %s"] = "%s e depois %s"
L["24-Hour Time"] = "24 horas"
L["2D"] = "2D"
L["3D"] = "3D"
L["Abbreviate Name"] = "Abreviar Nome"
L["Above Chat (Inside)"] = "Acima do Bate-papo (Dentro)"
...
L["Add a Item Name or ID to the list."] = "Adicionar o Nome do Item ou ID para a lista."
...
L["Add an Item by dragging it, shift-clicking, or entering the Item ID onto this field."] = "Adicione um Item arrastando-o, shift+clique esquerdo, ou digitando o ID de Item neste campo."
L["Add Currency by ID"] = "Adicionar ID de Moeda"
L["Add Currency"] = "Adicionar Moeda"
L["Add Current"] = "Adicionar Atual"
L["Add Instance ID"] = "Adicionar ID da Instância"
L["Add Item Name or ID"] = "Adicionar Nome de Item ou ID"
...
L["Adjust the height of your left chat panel."] = "Ajuste a altura do seu painel esquerdo de bate-papo."
L["Adjust the height of your right chat panel."] = "Ajuste a altura do seu painel direito de bate-papo."
L["Adjust the scale of the minimap and also the pins. Eg: Quests, Resource nodes, Group members"] = "Ajuste a escala do minimapa e também os pinos. Ex: Missões, Nódulos de Recuros, Membros do Grupo"
...
L["Adjust the width of your left chat panel."] = "Ajuste a largura do seu painel esquerdo de bate-papo."
...
L["Alpha Fading"] = "Desvanecimento de Transparência"
L["Alpha Key"] = "Chave de Transparência"
...
L["Another Players Pet"] = "Mascote de Outros Jogadores"
L["Any"] = "Qualquer"
...
L["Arrow Scale"] = "Escala da Flecha"
L["Arrow Spacing"] = "Espaçamento da Flecha"
L["Arrow Texture"] = "Textura da Flecha"
L["Ascending or Descending order."] = "Ordem crescente ou decrescente."
L["Ascending"] = "Ascendente"
L["Assigned Icon"] = "Ícone Atribuido"
...
L["Attempts to center UI elements in a 16:9 format for ultrawide monitors"] = "Tenta centralizar elementos da IA em um formato 16:9 para monitores ultrawide"
L["Auction House"] = "Casa de Leilões"
L["AUCTIONS"] = "Leilões"
L["Aura Filters"] = "Filtro de Auras"
L["Aura Highlight"] = "Destaque de Aura"
L["Aura Indicator"] = "Indicador de Aura"
L["Auto Add New Spells"] = "Auto-adicionar novos feitiços"
L["Auto Hide"] = "Auto-esconder"
L["Auto Repair"] = "Reparar automaticamente"
L["Auto Self Cast"] = "Autolançar em si"
L["Auto Toggle"] = "Auto Ativar/Desativar"
L["Auto Track Reputation"] = "Auto Rastrear Reputação"
...
L["Backdrop Faded"] = "Fundo Desvanecido"
L["Backdrop Settings"] = "Configurações do Fundo"
L["Backdrop Spacing"] = "Espaço do fundo"
L["Backdrop Transparency"] = "Transparência do Fundo"
L["Backdrop"] = "Fundo"
L["Background Glow"] = "Brilho do Fundo"
L["Backpack Only"] = "Apenas a Mochila"
L["Bad Color"] = "Cor ruim"
L["Bad Scale"] = "Escala ruim"
L["Bad Transition Color"] = "Cor Ruim de Transição"
L["Bad Transition"] = "Transição Ruim"
L["Bad"] = "Ruim"
L["Bag %d"] = "Bolsa %d"
...
L["BALANCE_ENERGY_LUNAR"] = "Energia Lunar"
L["BALANCE_ENERGY_SOLAR"] = "Energia Solar"
...
L["Battlefield"] = "Campo de Batalha"
...
L["Blend Mode"] = "Modo de Mesclagem"
L["Blend"] = "Mesclagem"
L["Blizzard CVars"] = "CVars da Blizzard"
...
L["Block Focus Glow"] = "Bloquear Brilho do Foco"
...
L["Border Options"] = "Opções da Borda"
L["Border"] = "Borda"
L["Borders By Dispel"] = "Bordas por Dissipabilidade"
L["Borders By Type"] = "Bordas por Tipo"
L["Borders"] = "Bordas"
L["Boss Mod Auras"] = "Auras de Boss Mods"
L["Both users will need this option enabled."] = "Ambos os usários tem que ter esta opção habilitada."
L["Both"] = "Ambos"
...
L["Buffs on Debuffs"] = "Bônus em Penalidades"
L["Button Flash"] = "Brilho do Botão"
L["Button Height"] = "Altura do Botão"
L["Button Settings"] = "Configurações do Botão"
...
L["Camera Spin"] = "Giro da Câmera"
L["Camera"] = "Câmera"
L["Can Attack"] = "Pode Atacar"
L["Can Not Attack"] = "Não pode Atacar"
L["Cart / Flag / Orb / Assassin Bounty"] = "Carrinho / Bandeira / Orbe / Recompensa de Assassino"
L["Cast Bar"] = "Barra de Lançamento"
L["Cast Time Format"] = "Formato do Tempo de Lançamento"
L["Casted by Player Only"] = "Lançado apenas por Jogador"
L["Casting"] = "Lançando"
L["Center"] = "Centro"
...
L["Change the width and controls how big of an area on the screen will accept clicks to target unit."] = "Mudar a largura e controla o quão grande a área na tela será para aceitar cliques na unidade"
...
L["Charge Draw Swipe"] = "Desenho de Deslize de Recarga"
L["Charged Combo Point"] = "Ponto de Combo Carregado"
L["Charging Rune Color"] = "Cor de Runa quando Carregando"
...
L["Check Focus Cast"] = "Checar Lançamento do Foco"
L["Check Mouseover Cast"] = "Checar Lançamento do Mouse Passando"
L["Check Self Cast"] = "Checar Autolançamento"
...
L["CheckBox Skin"] = "Modificação da Caixa de Seleção"
L["CHI_POWER"] = "Chi"
...
L["Chromie Time Frame"] = "Quadro do Tempo de Chromie"
...
L["Cluster Backdrop"] = "Agrupamento de Fundo"
...
L["Color Backdrop"] = "Colorir Fundo"
L["Color by Happiness"] = "Colorir por Felicidade"
L["Color By Spec"] = "Colorir por Especialização"
L["Color by Unit Class"] = "Colorir por Classe da Unidade"
L["Color by Value"] = "Colorir por Valor"
L["Color castbar by the class of the unit's class."] = "Colorir Barra de Lançamento pela classe da unidade."
L["Color castbar by the reaction of the unit to the player."] = "Colorir Barra de Lançamento pela reação da unidade ao jogador."
...
L["Color Debuffs"] = "Colorir Penalidades"
L["Color Enchants"] = "Colorir Encantos"
...
L["Color of the Targets Aura time when expiring."] = "Cor da Aura do Alvo quando o tempo estiver acabando."
L["Color of the Targets Aura time."] = "Cor do Tempo da Aura do Alvo"
L["Color Override"] = "Sobrescrever Cor"
L["Color Picker"] = "Escolhedor de Cores"
...
L["Color score based on Blizzards API."] = "Colorir pontuação baseando na API da Blizzard."
L["Color Score"] = "Colorir Pontuação"
...
L["Color tooltip border based on Item Quality."] = "Colorir borda da dica baseando na Qualidade do Item."
L["Color Turtle Buffs"] = "Colorir bônus de Tartaruga"
L["Color when at half of the Low Health Threshold"] = "Colorir quando estiver na metade do Limite Baixo de Saúde"
L["Color when at Low Health Threshold"] = "Colorir quando estiver no Limite Baixo de Saúde"
...
L["Color when the text is using a modified timer rate."] = "Colorir quando o texto estiver usando uma taxa de modificação de tempo."
L["COLOR"] = "Cor"
L["Colored Icon"] = "Ícone Colorido"
L["Coloring (Specific)"] = "Coloração (Específica)"
L["Coloring"] = "Coloração"
L["Colorize Selected Text"] = "Colorir o Texto Selecionado"
...
L["Completed Quests Only"] = "Apenas Objetivos Completados"
L["Completely hide the voice buttons."] = "Esconder completamente os botões de voz"
L["Condensed (Spaced)"] = "Condensado (Espacionado)"
...
L["Copy Primary Texture"] = "Copiar Textura Primária"
...
L["Count Text"] = "Texto de Contagem"
...
L["Cursor Anchor Offset X"] = "Deslocamento X da Âncora do Cursor"
...
L["Cutaway Bars"] = "Barras Cortadas"
L["DAMAGER"] = "Dano"
...
L["Debuffs on Buffs"] = "Penalidades em Bônus"
L["Debug Tools"] = "Ferramentas de Depuração"
L["DEBUG_DESC"] = "Desabilitar todos os addons (incluindo Plugins) exceto o ElvUI. Durante esta mesma seção, isto pode ser clicado para reativá-los."
...
L["Delay Alpha"] = "Atraso de Transparência"
...
L["Desaturate Junk"] = "Desaturar Lixo"
...
L["Development Version"] = "Versão de Desenvolvimento"
...
L["Disable Blizzard Skins"] = "Desabilitar Modificações Blizzard"
L["Disable Cluster"] = "Desabilitar Agrupamento"
L["Disable Sort"] = "Desabilitar Classificação"
...
L["Display a healer icon over known healers inside battlegrounds or arenas."] = "Mostra um ícone de Curandeiro sobre curandeiros conhecidos em campos de batalha ou arenas."
...
L["Display a tank icon over known tanks inside battlegrounds or arenas."] = "Exibir um ícone de tanque sobre os tanques dentro de campos de batalha ou arenas."
...
L["Display Item Info"] = "Mostrar Informações do Item"
...
L["Display Target's Aura Duration, when there is no CD displaying."] = "Mostrar a Duração da Aura do Alvo, quando não há uma recarga sendo mostrada."
...
L["Display the current Mythic+ Dungeon Score."] = "Mostra a Pontuação Atual das Masmorras Míticas+"
...
L["Display the item level and current specialization of the unit on modifier press."] = "Mostra o nível do item e especialização atual da unidade quando um modificador for pressionado."
...
L["Display the target of current cast."] = "Mostra o alvo do lançamento atual."
...
L["Displays item info on center of item."] = "Mostra informação do item no centro do item."
L["Displays item level on equippable items."] = "Mostra o item level de itens equipáveis."
L["Displays the gender of players."] = "Mostra o gênero dos jogadores."
...
L["Duration"] = "Duração"
L["Editbox History"] = "Histórico do Campo de Edição"
L["Editor Manager"] = "Gerenciador de Edição"
...
L["Empower Stages"] = "Estágios Potencializados"
...
L["Enable Blizzard Skins"] = "Habilitar Modificações Blizzard"
...
L["Enable/Disable the on-screen zone text when you change zones."] = "Habilitar/Desabilitar o texto de zona na tela quando você muda de zona."
L["Enable/Disable the World Map Enhancements."] = "Habilitar/Desabilitar as Melhorias do Mapa"
L["Enabled"] = "Habilitar"
L["Enables the ElvUI Raid Control panel."] = "Habilita o painel de Controle de Raíde do ElvUI."
L["Enables the five-second-rule ticks for Mana classes and Energy ticks for Rogues and Druids."] = "Habilitar a regra de cinco segundos para classes com Mana e Energia como Ladinos e Druídas"
...
L["ENERGY"] = "Energia"
L["Energy/Mana Regen Tick"] = "Marco de Tempo de Regeneração de Energia/Mana"
L["Engineering"] = "Engenharia"
L["Enhanced PVP Messages"] = "Melhorias nas mensagens PVP"
L["Equipped Item"] = "Item Equipado"
L["Equipped"] = "Equipado"
...
L["Event Log"] = "Registros de Eventos"
...
L["Expansion Button"] = "Botão de Expansão"
...
L["Fade Chat Toggles"] = "Alternar Desvanecimento dos botões de bate-papo"
L["Fade Duration"] = "Duração de Desvanecimento"
L["Fade Out Delay"] = "Delay de Desvanecimento"
L["Fade out the tooltip when it disappers, instant otherwise. Cursor anchored tooltips are unaffected."] = "Desvanecer a dica quando ela desaparecer, será instântanea caso contrário. Dicas ancoras ao Cursor não são afetadas."
...
L["Faded Charging Rune"] = "Desvanecer Runa em Carregamento"
L["Fader"] = "Desvanecimento"
L["Fades the buttons that toggle chat windows when that window has been toggled off."] = "Desvanece os botões que habilitam/desabilitam as janelas de bate-papo quando essa janela for desabilitada."
L["Fades the text on chat tabs that are docked in a panel where the backdrop is disabled."] = "Desvanece o textos das abas de bate-papo que estão ancoradas em um painel onde o fundo está desabilitado."
L["Fades the text on chat tabs that are not docked at the left or right chat panel."] = "Desvanece o texto das abas de bate-papo que não estão ancoradas ao painel esquerdo ou direito."
L["Fill"] = "Preencher"
L["Filled"] = "Preenchido"
L["Filter Modifiers"] = "Filtrar Modificadores"
...
L["Filters"] = "Filtros"
L["Flash Client Icon"] = "Piscar Ícone do Cliente"
L["Flash Invites"] = "Piscar Convites"
L["Flash Threshold"] = "Limiar para Pisco"
L["Flash"] = "Pisco"
L["FLIGHT_MAP"] = "Mapa de voo"
L["Fluid Buffs on Debuffs"] = "Bônus Fluidos em Penalidades"
L["Fluid Debuffs on Buffs"] = "Penalidades Fluidas em Bônus"
L["Flyout Button Size"] = "Tamanho de Botões Suspensos"
L["Flyout Direction"] = "Direção de Botão Suspenso"
L["Focus Cast Key"] = "Tecla para lançamento em Foco"
L["FOCUS"] = "Concentração"
L["Focus"] = "Foco"
L["Focused Glow"] = "Brilho Focado"
L["FocusTarget"] = "Focar Alvo"
L["Font Group"] = "Grupo de Fonte"
...
L["Forces Focus Glow to be disabled for these frames"] = "Força o Brilho de Foco a ser desabilitado para estes quadros"
...
L["Friends"] = "Amigos"
L["From Me"] = "De mim"
L["From Pet"] = "De meu mascote"
L["Full Bar"] = "Barra Preenchida"
L["Full Overlay"] = "Sobreposição Preenchida"
L["Full Time"] = "Tempo Cheio"
L["Full"] = "Cheio"
L["FURY"] = "Fúria"
L["Gaining Threat"] = "Ganhando Ameaça"
...
L["Groups will be maxed as Mythic to 4, Other Raids to 6, and PVP / World to 8."] = "Grupos serão no máximo: 4 em Mítico, outras Raídes 6, e PVP / Mundo 8."
...
L["Guild"] = "Guilda"
L["Half Bar"] = "Meia Barra"
L["Happy"] = "Feliz"
L["Has Aura"] = "Tem Aura"
L["Has No Stealable"] = "Não tem Roubável"
L["Has NPC Title"] = "Tem Título de NPC"
L["Has Stealable"] = "Tem Roubável"
L["Headers"] = "Cabeçalhos"
L["Heal Absorbs"] = "Absorções de Cura"
L["Heal Prediction"] = "Curas por vir"
L["Healer Icon"] = "Ícone de Curador"
L["Health Backdrop Multiplier"] = "Multiplicador de Fundo da Vida"
L["Health Backdrop"] = "Fundo da Vida"
L["Health Bar"] = "Barra de Vida"
L["Health Border"] = "Borda da Vida"
L["Health Breakpoint"] = "Ponto de parada da Vida"
...
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "Aqui você pode adicionar items que você quer excluir da classificação. Para remover um item apenas clique no seu nome na lista."
...
L["Hide by Application"] = "Esconder por Aplicação"
L["Hide by Status"] = "Esconder por Estado"
...
L["Hide Channels"] = "Esconder Canais"
L["Hide Chat Toggles"] = "Esconder Alternadores de Bate-papo"
L["Hide Cooldown Bling"] = "Esconder Brilho da Recarga"
L["Hide Copy Button"] = "Esconder Botão de Cópia"
L["Hide Delay"] = "Esconder Delay"
L["Hide Error Text"] = "Esconder Texto de Erro"
L["Hide Frame"] = "Esconder Quadro"
L["Hide Icon"] = "Esconder Ícone"
L["Hide In Combat"] = "Esconder em Combate"
L["Hide In Keystone"] = "Esconder em Chave Mítica+"
...
L["Hide the channel names in chat."] = "Esconder os nomes dos canais de bate-papo"
L["Hide Time"] = "Esconder horário"
L["Hide Voice Buttons"] = "Esconder botões de voz"
L["Hide When Empty"] = "Esconder quando vazio"
L["Hide Zone Text"] = "Esconder o Texto de Zona"
L["Hide"] = "Esconder"
L["Hides the bling animation on buttons at the end of the global cooldown."] = "Esconder a animação nos botões no fim de um tempo de recarga global."
...
L["High"] = "Alto"
L["Highlight Color Style"] = "Estilo da Cor de Destaque"
...
L["How long the cutaway health will take to fade out."] = "Quanto tempo a vida cortada levará para desvanecer."
L["How long the cutaway power will take to fade out."] = "Quando tempo o poder cortado levará para desvanecer."
L["How many seconds the castbar should stay visible after the cast failed or was interrupted."] = "Quantos segundos a barra de lançamento deve continuar visível depois de um lançamento falhar ou ser interrompido."
L["How much time before the cutaway health starts to fade."] = "Quanto tempo antes da vida cortada começar a desvanecer."
L["How much time before the cutaway power starts to fade."] = "Quanto tempo antes do poder cortado começar a desvanecer."
...
L["If enabled then the filter will activate if the unit is casting anything."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade está lançando algo."
L["If enabled then the filter will activate if the unit is channeling anything."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver canalizando algo."
L["If enabled then the filter will activate if the unit is not casting anything."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver lançando algo."
L["If enabled then the filter will activate if the unit is not channeling anything."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver canalizando algo."
...
L["If enabled then the filter will only activate when the unit has a stealable buff(s)."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade tiver um bônus roubável."
L["If enabled then the filter will only activate when the unit has no stealable buff(s)."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade não tiver um bônus roubável."
...
L["If enabled then the filter will only activate when the unit is in your Party."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver em seu Grupo."
L["If enabled then the filter will only activate when the unit is in your Raid."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver em sua Raíde."
...
L["If enabled then the filter will only activate when the unit is not in your Party."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver no seu Grupo."
L["If enabled then the filter will only activate when the unit is not in your Raid."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver na sua Raíde."
...
L["If enabled then the filter will only activate when the unit is not tap denied."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade não for estiver reservada."
...
L["If enabled then the filter will only activate when the unit is tap denied."] = "Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver reservada."
...
L["If enabled then the filter will only activate when you have a target."] = "Se habilitado então o filtro irá apenas ser ativado quando você tiver um alvo."
...
L["If you unlock actionbars then trying to move a spell might instantly cast it if you cast spells on key press instead of key release."] = "Se você destravar as Barras de Ações, tentar mover um feitiço pode fazê-lo ser lançado se você casta feitiços ao pressionar a tecla em vez de quando soltá-la."
L["Ignore mouse events."] = "Ignorar eventos do mouse (rato)."
L["Ignored Items (Global)"] = "Itens Ignorados (Global)"
L["Ignored Items (Profile)"] = "Itens Ignorados (Perfil)"
L["Import Now"] = "Importar Agora"
L["Import Profile"] = "Importar Perfil"
L["Import"] = "Importar"
L["Importing"] = "Importando"
L["In Combat Label"] = "Rótulo em Combate"
L["In Combat"] = "Em Combate"
L["In Party"] = "Em Grupo"
L["In Pet Battle"] = "Em Batalha de Mascote"
L["In Raid"] = "Em Raíde"
L["In Vehicle"] = "Em Veículo"
L["Inactivity Timer"] = "Tempo de Inatividade"
L["Index"] = "Índice"
L["Indicate whether buffs you cast yourself should be separated before or after."] = "Indica se os bônus que lança em si próprio devem ser separados antes ou depois."
...
L["Inset"] = "Margem"
L["Inspect Data"] = "Dados de Inspeção"
...
L["INVTYPE_AMMO"] = "Munição"
L["INVTYPE_BODY"] = "Camisa"
L["INVTYPE_CHEST"] = "Torso"
L["INVTYPE_CLOAK"] = "Costas"
L["INVTYPE_FEET"] = "Pés"
L["INVTYPE_FINGER1"] = "Dedo 1"
L["INVTYPE_FINGER2"] = "Dedo 2"
L["INVTYPE_HAND"] = "Mãos"
L["INVTYPE_HEAD"] = "Cabeça"
L["INVTYPE_LEGS"] = "Pernas"
L["INVTYPE_NECK"] = "Pescoço"
L["INVTYPE_RANGED"] = "Longo alcance"
L["INVTYPE_SHOULDER"] = "Ombros"
L["INVTYPE_TABARD"] = "Tabardo"
L["INVTYPE_TRINKET1"] = "Berloque 1"
L["INVTYPE_TRINKET2"] = "Berloque 2"
L["INVTYPE_WAIST"] = "Cintura"
L["INVTYPE_WEAPONMAINHAND"] = "Mão principal"
L["INVTYPE_WEAPONOFFHAND"] = "Mão Secundária"
L["INVTYPE_WRIST"] = "Pulsos"
L["Is Being Resurrected"] = "Está sendo Ressuscitado"
...
L["Keyword Alerts"] = "Alerta de palavra-chave"
L["Keywords"] = "Palavras-chave"
L["Known Spells"] = "Feitiços Conhecidos"
L["Label"] = "Rótulo"
L["LANGUAGE"] = "Idioma"
L["Large"] = "Grande"
L["Larger Font"] = "Fonte Maior"
L["Larger Outline"] = "Contorno Maior"
L["Larger Size"] = "Tamanho Maior"
L["Latency"] = "Latência"
L["Leatherworking"] = "Couraria"
L["Left Alt"] = "Alt Esquerdo"
L["Left Buttons"] = "Botões Esquerdos"
L["Left Control"] = "Control Esquerdo"
L["Left Only"] = "Somente Esquerda"
L["Left Panel Height"] = "Altura do Painel Esquerdo"
L["Left Panel Width"] = "Largura do Painel Esquerdo"
L["Left Position"] = "Posição Esquerda"
...
L["Library Dropdown"] = "Menus de Suspensão de Bibliotecas"
...
L["Link to the latest PTR version."] = "Link para a última versão de PTR."
...
L["Load Distance"] = "Distância de Carregamento"
L["Loadout Only"] = "Apenas em Configuração de Equipamento"
L["Local Time"] = "Hora Local"
L["Location Text"] = "Texto de Localização"
L["Lock Distance Max"] = "Travar Distância Máxima"
...
L["Low Health Color"] = "Cor de Vida Baixa"
L["Low Health Half"] = "Cor de Metade Baixa da Vida"
L["Low Health Threshold"] = "Limiar de Vida Baixa"
L["Low Threat"] = "Ameaça Baixo"
...
L["Make the unitframe glow when it is below this percent of health."] = "Faz o quadro de unidade brilhar quanto estiver abaixo desta porcentagem de vida."
...
L["Masque"] = true
L["Match if Item Name or ID is NOT in the list."] = "Igualar se o Nome do Item ou ID NÃO estiver na lista."
...
L["Match this trigger if the spell is not known."] = "Igualar este gatilho apenas se o feitiço não for conhecido"
L["Maw Buffs Position"] = "Posição do Bônus da Gorja"
L["Max Allowed Groups"] = "Grupos Máximos Permitidos"
L["Max Alpha"] = "Transparência Máxima"
L["Max amount of overflow allowed to extend past the end of the health bar."] = "Quantidade máxima de sobreposição permitida para extender além do fim da barra de vida."
L["Max Bars"] = "Barras Máximas"
L["Max Distance"] = "Distância Máxima"
L["Max Lines"] = "Linhas Máximas"
L["Max Overflow is set to zero. Absorb Overflows will be hidden when using Overflow style.\nIf used together Max Overflow at zero and Overflow mode will act like Normal mode without the ending sliver of overflow."] = "Sobreposição Máxima não está configurada para azero. A Sobreposição de Absorção será escondida quando estiver utilizando o estilo de Sobreposição.\nSe utilizados juntos a Sobreposição Máxima em zero e a Sobreposição vão agir como o modo Normal sem o traço final da sobreposição."
...
L["Missing Aura"] = "Aura Faltando"
L["Missing"] = "Faltando"
L["MM:SS Threshold"] = "Limiar MM:SS"
L["MM:SS"] = true
L["Model Rotation"] = "Girar o Modelo"
L["Modified Rate"] = "Taxa Modificada"
L["Modifier Count"] = "Contador de Modificação"
...
L["Monitor"] = true
L["Mouseover Cast Key"] = "Tecla de Lançamento ao Pairar o Mouse"
L["Mouseover Glow"] = "Brilhar ao Pairar o Mouse"
L["Mouseover Highlight"] = "Realçar ao Pairar o Mouse"
L["Mouseover"] = "Pairar o Mouse"
L["Movers"] = "Movedores"
L["Multi-Monitor Support"] = "Suporte a Múltiplos Monitores"
L["Multiple Ranks"] = "Ranques Múltiplos"
...
L["Must be in group with the player if he isn't on the same server as you."] = "Deve estar em um grupo com o jogador se ele não estiver no mesmo servidor que você."
L["My Guild"] = "Minha Guilda"
L["Mythic+ Best Run"] = "Melhor Corrida de Mítica+"
L["Mythic+ Data"] = "Dados de Mítica+"
L["Mythic+ Score"] = "Pontuação de Mítica+"
L["Name Font"] = "Fonte de Nomes"
L["Name Only"] = "Apenas Nome"
L["Name Style"] = "Estilo de Nome"
L["Name Taken"] = "Nome Tomado"
L["Name"] = "Nome"
...
L["Nameplate Thin Borders"] = "Bordas finas de Placas de Identificação"
L["Nameplate"] = "placa de identificação"
L["Nameplates"] = "Placas de Identificação"
L["Names"] = "Nomes"
L["Negative Match"] = "Acerto negativo"
L["Neutral"] = "Neutro"
L["New Item Glow"] = "Brilho de Item Novo"
L["New Panel"] = "Novo Painel"
L["No Alert In Combat"] = "Sem alerta durante combate"
L["No Duration"] = "Sem Duração"
L["No Icon"] = "Sem Ícone"
L["No Label"] = "Sem Rótulo"
...
L["Normal Font"] = "Fonte Normal"
L["Normal Outline"] = "Contorno Normal"
L["Normal Size"] = "Tamanho Normal"
L["Normal"] = true
L["Not Another Players Pet"] = "Não é mascote de outro jogador"
L["Not Being Resurrected"] = "Não está sendo Ressuscitado"
L["Not Casting Anything"] = "Não castando nada"
L["Not Channeling Anything"] = "Não canalizando nada"
L["Not Charmed"] = "Não Encantado"
L["Not Focused"] = "Não é o foco"
L["Not in Party"] = "Não está em Grupo"
L["Not in Raid"] = "Não está em Raíde"
L["Not Known"] = "Não Conhecido"
L["Not My Guild"] = "Não é da minha Guilda"
L["Not Owned By Player"] = "Não pertence a outro Jogador"
L["Not Pet Battle"] = "Não é Combate de Mascote"
L["Not Pet"] = "Não é Mascote"
L["Not Player Controlled"] = "Não é controlado por Jogador"
L["Not Possessed"] = "Não está possuído"
L["Not PvP"] = "Não é JxJ"
L["Not Quest Unit"] = "Não é Unidade de Objetivo"
L["Not Resting"] = "Não está Descansando"
L["Not Spell"] = "Não é feitiço"
L["Not Tap Denied"] = "Não está Reservado"
L["Not Targeted"] = "Não é o alvo"
L["Not Targeting Player"] = "Não tem jogador como alvo"
L["Not Trivial"] = "Não é Trivial"
L["Not Usable"] = "Não usável"
L["NPC"] = true
L["Num Rows"] = "Número de linhas"
L["Number Allowed"] = "Número Permitido"
L["Number of DataTexts"] = "Número de Textos de Informação"
...
L["Off Tank (Pets)"] = "Tanque Secundário (Mascotes)"
L["Off Tank Bad Transition"] = "Transição Ruim de Tanque Secundário"
L["Off Tank Good Transition"] = "Transição Boa de Tanque Secundário"
L["Off Tank"] = "Tanque Secundário"
L["Officer"] = "Oficial"
L["Offset of the powerbar to the healthbar, set to 0 to disable."] = "A distância entre barra de poder e a barra de vida, definir 0 para desativar."
L["Offset"] = "Distância"
...
L["Only show icons instead of specialization names"] = "Apenas mostrar ícones ao invés de nomes de especializações"
L["Only Used Slots"] = "Apenas Vagas Utilizadas"
L["OPACITY"] = "Opacidade"
...
L["Others"] = "Outros"
L["Out of Combat Label"] = "Rótulo Fora de Combate"
L["Out of Combat"] = "Fora de Combate"
L["Out of Power"] = "Sem Poder"
L["Out of Range"] = "Fora de Alcance"
L["Out of Vehicle"] = "Fora de Veículo"
L["Over Absorbs"] = "Sobre Absorções"
L["Over Heal Absorbs"] = "Sobre Absorções de Cura"
L["Over Health Threshold"] = "Sobre limiar de Vida"
L["Over Power Threshold"] = "Sobre limiar de Poder"
L["Overflow"] = "Sobreposição"
L["Overlap Horizontal"] = "Sobreposição Horizontal"
L["Overlap Vertical"] = "Sobreposição Vertical"
L["Overlay Alpha"] = "Transparência de Sobreposição"
L["Overlay mode is forced when the Frame Orientation is set to Middle."] = "Modo de Sobreposição é forçado quando a Orientação do Quadro estiver em Meio."
L["Overlay"] = "Sobrepor"
L["Override the default class color setting."] = "Sobrescreve a configuração de cor de classe padrão."
L["Owned By Player"] = "Possuído por Jogador"
L["PAIN"] = "Dor"
L["Panel Backdrop"] = "Fundo do Painel"
L["Panel Height"] = "Altura do Painel"
L["Panel Options"] = "Opções do Painel"
L["Panel Snapping"] = "Encaixe do Painel"
...
L["Pet Happiness"] = "Felicidade do Mascote"
L["Pet"] = "Mascote"
...
L["Player Choice Frame"] = "Quadro de Escolha de Jogador"
L["Player Controlled"] = "Controlado por Jogador"
...
L["Player Spell"] = "Feitiço de Jogador"
...
L["Prefer Target Color"] = "Preferir Cor do Alvo"
...
L["Profession Quality"] = "Qualidade de Profissão"
...
L["Quality Background"] = "Qualidade de Fundo"
L["Quality Itemlevel"] = "Qualidade de Nível de Item"
L["Quality Name"] = "Qualidade de Nome"
L["Quality StatusBar"] = "Barra de Qualidade"
L["Quest Boss"] = "Chefe de Objetivo"
L["Quest Choice"] = "Escolha de Objetivo"
L["Quest Experience"] = "Experiência de Objetivo"
L["Quest Frames"] = "Quadro de Quests"
L["Quest Icon"] = "Ícone de Objetivo"
L["Quest Starter Icon"] = "Ícone de Iniciar Objetivo"
L["Quest Starter"] = "Iniciador de Objetivo"
L["Quest Unit"] = "Unidade de Objetivo"
L["Quests in Current Zone Only"] = "Objetivos apenas na Zona Atual"
L["Quests"] = "Objetivos"
L["Queue Status"] = "Estado da Fila"
L["Quick Join Messages"] = "Mensagem de entrada-rápida"
L["Quiver / Ammo"] = "Aljava / Munição"
L["RAGE"] = "Raiva"
L["Raid Debuff Indicator"] = "Indicador das Penalidades da Raíde"
L["Raid Difficulty"] = "Dificuldade da Raíde"
L["Raid Frame"] = "Quadro de Raíde"
L["Raid Only"] = "Apenas Raíde"
L["Raid Pet"] = "Mascotes da Raíde"
L["Raid Role Indicator"] = "Indicador de Papel na Raíde"
L["Raid"] = "Raíde"
L["Raid-Wide Sorting"] = "Ordenação por toda a Raíde"
L["RAID_CONTROL"] = "Controle de raídes"
L["RAID_INFO_WORLD_BOSS"] = "Chefe de mundo:"
L["Range"] = "Alcance"
L["Rarity Color"] = "Cor de Raridade"
L["Reaction Castbars"] = "Barras de Lançamentos por Reação"
L["Reaction Color"] = "Cor de Reação"
L["Reaction Colors"] = "Cores de Reações"
L["Reaction Type"] = "Tipo de Reação"
L["Reaction"] = "Reação"
L["Reactions"] = "Reações"
L["Ready Check Icon"] = "Ícone de Checagem de Prontidão"
L["Reagent"] = "Reagente"
L["Remaining / Max"] = "Restante / Máximo"
L["Remaining"] = "Restante"
L["Remove a Item Name or ID from the list."] = "Remove um Nome de Item ou ID da lista."
...
L["Remove Item Name or ID"] = "Remover Nome de Item ou ID"
L["Remove Map ID"] = "Remover ID do Mapa"
L["Remove Name or NPC ID"] = "Remover Nome ou ID do NPC"
L["Remove Spell - %s"] = "Remover Feitiço - %s"
...
L["Replace Combat Font"] = "Substituir Fonte de Combate"
L["Replace Font"] = "Substituir Fonte"
L["Replace Name Font"] = "Substituir Fonte do Nome"
L["Replace Nameplate Fonts"] = "Substituir Fontes das Placas de Identificação"
L["Replace Text on Me"] = "Substituir Texto em Mim"
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI Options. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] = "Substituir as fontes padrão da Blizzard em vários painéis com as fontes escolhidas na seção de Mídia das Opções do ElvUI. NOTA: Qualquer fonte que segue as fontes que o ElvUI normalmente substitui também será afetada por isto se você desabilitar. Habilitado por padrão."
L["Replaces the font on Blizzard Nameplates."] = "Substituir a fonte das placas de identificação da Blizzard"
L["Replaces the StatusBar texture setting on Unitframes and Nameplates with the primary texture."] = "Substituir a textura da Barra de Estado dos Quadros de Unidades e Placas de Identificação com a textura primária."
L["Reposition Window"] = "Reposicionar Janela"
L["Reputation Alpha"] = "Transparência da Reputação"
...
L["Require Target"] = "Requerer Alvo"
L["Reset Action Paging"] = "Restaurar Paginação de Ação"
L["Reset all frames to their original positions."] = "Restaurar todos os quadros para suas posições originais."
L["Reset Aura Filters"] = "Restaurar Filtros de Auras"
L["Reset Chat Position"] = "Restaurar Posição do Bate-papo"
L["Reset CVars"] = "Restaurar CVars"
L["Reset Editbox History"] = "Restaurar Histórico da Caixa de Edição"
L["Reset Filter - %s"] = "Restaurar Filtro - %s"
L["Reset filter priority to the default state."] = "Restaurar prioridade de filtros para o status padrão."
L["Reset Filter"] = "Restaurar Filtro"
L["Reset History"] = "Restaurar Histórico"
L["Reset Nameplate CVars to the ElvUI recommended defaults."] = "Restaurar CVars das Placas de identificação para o recomendado pelo ElvUI."
L["Reset Priority"] = "Restaurar Prioridade"
L["Reset the size and position of this frame."] = "Restaurar o tamanho e posição deste quadro."
L["Reset Zoom"] = "Restaurar Zoom"
...
L["Reverse Toggle will enable Cooldown Text on this module when the global setting is disabled and disable them when the global setting is enabled."] = "Inverter a Habilitação vai habilitar o Texto de Recarga deste módulo quando a configuração global estiver desabilitada e irá desabilitá-la quando a configuração global estiver habilitada."
L["Reverse Toggle"] = "Inverter Habilitação"
L["Reverse"] = "Inverter"
L["REVERSE_NEW_LOOT_TEXT"] = "Saquear para a Bolsa mais à Esquerda"
L["Reversed"] = "Invertido"
L["Reward Icon"] = "Ìcone de Recompensa"
L["Reward Position"] = "Posição da Recompensa"
...
L["Right Position"] = "Posição Direita"
L["Right Shift"] = "Shift Esquerdo"
L["Right to Left"] = "Esquerda para Direita"
L["Right"] = "Direita"
L["Role Icon"] = "Ícone do Papel"
L["Role Order"] = "Ordem de Papel"
L["ROLE"] = "Função"
L["Round Timers"] = "Tempos Arredondados"
L["Run the installation process."] = "Rodar o processo de instalação"
L["RUNE_BLOOD"] = "	Runa de Sangue"
L["RUNE_CHARGE"] = "Runa Carregando"
L["RUNE_DEATH"] = "Runa"
L["RUNE_FROST"] = "Runa Gélida"
L["RUNE_UNHOLY"] = "Runa Profana"
L["Runeforge"] = "Runogravura"
L["RUNES"] = "Runas"
...
L["School"] = "Escola"
L["Scrap Icon"] = "Ícone Sucateável"
L["SCRAP_BUTTON"] = "Sucatear"
L["Scroll Interval"] = "Intervalo de Rolar"
L["Scroll Messages"] = "Mensagems de Rolagem"
...
L["Selected Text Color"] = "Cor do Texto Selecionado"
L["Selection Health"] = "Vida Selecionada"
L["Selection Power"] = "Poder Selecionado"
L["Selection"] = "Seleção"
L["Selector Color"] = "Cor de Seletor"
...
L["Set the alpha level of portrait when frame is overlayed."] = "Define o nível de transparência para o retrato quando o quadro estiver sobreposicionado."
...
L["Short (Whole Numbers Spaced)"] = "Curto (Números Inteiros Espacionados)"
...
L["Show All Tracking Options"] = "Mostrar Todas as Opções de Rastreamento"
L["Show an incoming heal prediction bar on the unitframe. Also display a slightly different colored bar for incoming overheals."] = "Mostra a barra de predição de cura no quadro de unidade. Também exibe uma barra com uma cor ligeiramente diferente para a predição de sobrecura."
...
L["Show Count"] = "Mostrar Contagem"
L["Show Dispellable Debuffs"] = "Mostrar penalidades dissipáveis"
L["Show ElvUI users and their version of ElvUI."] = "Mostrar usuários do ElvUI e a versão do ElvUI deles."
L["Show ElvUI Users"] = "Mostrar usuários do ElvUI"
...
L["Show Max Currency"] = "Mostrar Moeda Máxima"
L["Show Only Names"] = "Mostrar Apenas Nomes"
...
L["Show QuestXP"] = "Mostrar Experiência de Objetivo"
...
L["Shows a swipe animation when a spell is recharging but still has charges left."] = "Mostra uma animação de deslizamento quando um feitiço estiver recarregando mas ainda tiver cargas restantes."
...
L["Shows item level of each item, enchants, and gems when inspecting another player."] = "Mostra o Nível de Item de cada item, encantamentos e gemas quando inspecionando outros jogadores."
L["Side Arrows"] = "Setas laterais"
L["Size and Positions"] = "Tamanhos e Posições"
L["Size Offset"] = "Tamanho Deslocado"
...
L["Spec/Loadout"] = "Especialização/Configuração"
L["Specializations Only"] = "Apenas Especializações"
L["SPEED"] = "Velocidade"
L["Spell/Item IDs"] = "IDs de Feitiços/Itens"
L["SPELLBOOK"] = "Grimório"
L["Split"] = "Dividir"
L["Stable"] = "Estábulo"
L["Stack Auras"] = "Empilhar Auras"
L["Stack Counter"] = "Contador de Empilhamento"
L["Stack Threshold"] = "Limiar de Empilhamento"
L["Start Near Center"] = "Começar perto do Centro"
L["Status Bar"] = "Barra de Estado"
L["StatusBar Color"] = "Cor da Barra de Estado"
...
L["Supported"] = "Suportado"
L["Swap to Alt Power"] = "Mudar para Poder Alternativo"
L["Swapped Alt Power"] = "Poder Alternativo Mudado"
L["Swipe: Loss of Control"] = "Deslizamento: Perda de Controle"
L["Swipe: Normal"] = "Deslizamento: Normal"
...
L["Tab Panels"] = "Abas do Painel"
L["Tab Selector"] = "Seletor de Aba"
L["Tabard Frame"] = "Tabardo"
L["Table"] = "Tabela"
L["Tag Update Rate"] = "Taxa de atualização das Tags."
L["Tagged NPC"] = "NPC Reservado"
L["TALENTS"] = "Talentos"
L["Talking Head Backdrop"] = "Fundo da Cabeça Falante"
L["Talking Head Scale"] = "Escala da Cabeça Falante"
L["Talking Head"] = "Cabeça Falante"
L["Tank Colors"] = "Cores de Tanques"
L["Tank Frames"] = "Quadro do Tanques"
L["Tank Icon"] = "Ícone de Tanque"
L["Tank"] = "Tanque"
L["Tap Denied"] = "Reservação Negada"
L["Tapped"] = "Reservado"
L["Target Aura Expiring"] = "Aura do Alvo Expirando"
L["Target Aura"] = "Aura do Alvo"
L["Target Group"] = "Grupo do Alvo"
L["Target Indicator Color"] = "Indicador da Cor do Alvo"
L["Target Info"] = "Informações do Alvo"
L["Target Marker Icon"] = "Ícone de Marcação de Alvo"
L["Target On Mouse-Down"] = "Selecionar ao Pressionar o Mouse"
L["Target Reticle"] = "Retículo de Alvo"
L["Target units on mouse down rather than mouse up.\n|cffff3333Note:|r If Clique is enabled, this option only effects ElvUI frames if they are not blacklisted in Clique."] = "Selecionar alvo ao apertar o mouse ao invés de soltar.\n|cffff3333Nota:|r Se o Clique estiver instalado e habilitado, esta opção apenas afetará quadros do ElvUI se eles não estiverem bloqueados no Clique."
L["Target"] = "Alvo"
L["Target/Low Health Indicator"] = "Indicador de Alvo/Vida Baixa"
L["Targeted Glow"] = "Brilho quando Mirado"
L["Targeting Sound"] = "Som quando obtendo Alvo"
L["Targeting"] = "Mirando"
...
L["Text Justify"] = "Justificação do Texto"
L["Text Options"] = "Opções do Texto"
L["Text Position"] = "Posição do Texto"
L["Text Threshold"] = "Limiar do Texto"
L["Text Toggle On NPC"] = "Texto Alternado no NPC"
L["Text"] = "Texto"
L["Texts"] = "Textos"
L["Texture Matching"] = "Textura Igualada"
L["Texture"] = "Textura"
...
L["The button you must hold down in order to drag an ability to another action button."] = "Botão que deve ser pressionado para permitir o arrastar uma habilidade para outro botão de ação"
...
L["The direction that the bag frames be (Horizontal or Vertical)."] = "Direção em que os quadros das bolsas são (Horizontal ou Vertical)."
L["The direction that the bag frames will grow from the anchor."] = "Direção para qual as barras crescerão a partir do seu Fixador."
L["The direction the auras will grow and then the direction they will grow after they reach the wrap after limit."] = "A direção que as auras vão crescer e então a direção que elas vão crescer após chegarem no limite."
...
L["The height of the action buttons."] = "A Altura dos botões de ação."
...
L["The width of the action buttons."] = "A largura dos botões de ação."
...
L["This changes the size of the Aura Icon by this value."] = "Isto muda o tamanho do Ìcone de Aura por este valor."
...
L["This list will display any textures Boss Mods have sent to the Boss Mod Auras element during the current session."] = "Esta lista vai mostrar qualquer textura que Boss Mods mandou para o elemento de Aura Boss Mod durante a seção atual."
...
L["This uses the IsPlayerSpell API which is only required sometimes."] = "Isto utiliza a API IsPlayerSpell da Blizzard que só é necessária as vezes."
L["This will allow you to toggle flashing of the time datatext when there are calendar invites."] = "Isto vai permitir que voce alterne o brilho do texto de informação de tempo quando tiver convites para o calendário."
L["This will join auras together which are normally separated. Example: Bolstering and Force of Nature."] = "Isto vai juntar auras que ficam normalmente separadas. Exemplo: Força da Natureza."
...
L["Toggle the camera spin on the AFK screen."] = "Alterna a Rotação da Câmera na tela de AFK."
L["Toggle the chat tab panel backdrop."] = "Mostrar/ocultar o fundo da guia do bate-papo."
L["Toggle Tutorials"] = "Ativar Tutoriais"
L["Tooltip Body"] = "Corpo da Dica"
L["Tooltip Header"] = "Cabeçalho da Dica"
L["Tooltip Lines"] = "Linhas da Dica"
...
L["Top"] = "Superior"
L["Torghast Level Picker"] = "Escolhedor de Nível do Torghast"
L["TOTEM_AIR"] = "Totem do Ar"
L["TOTEM_EARTH"] = "Totem da Terra"
L["TOTEM_FIRE"] = "Totem do Fogo"
L["TOTEM_WATER"] = "Totem da Água"
L["Totems"] = "Totens"
L["Tracked Quests Only"] = "Apenas Objetivos Rastreados"
L["Tracking"] = "Rastreando"
L["TRADE"] = "Negociar"
L["TRADESKILLS"] = "Perícias profissionais"
L["Trainer Frame"] = "Instrutores"
L["TRANSMOGRIFY"] = "Transmogrificar"
L["Transparency level when not in combat, no target exists, full health, not casting, and no focus target exists."] = "Nível de transparência quando não estiver em combate, nenhum alvo existir, vida cheia, não estiver lançando, e nenhum foco existir."
L["Transparent"] = "Transparente"
L["Triggers"] = "Gatilhos"
L["Trivial"] = true
L["Turtle Color"] = "Cor para Tartaruga"
L["Tutorials"] = "Tutoriais"
L["Ultrawide Support"] = "Suporte para Ultrawide"
...
L["Unhappy"] = "Infeliz"
L["Unit Class Color"] = "Cor de Classe da Unidade"
...
L["Unitframe Thin Borders"] = "Bordas Finas dos Quadros de Unidades"
L["Unitframes Border"] = "Bordas dos Quadros de Unidades"
...
L["Up"] = "Acima"
L["Upgrade Icon"] = "Ìcone de Upgrade"
L["URL Links"] = "Links de URL"
L["Usable"] = "Usável"
...
L["Use Dead Backdrop"] = "Usar Fundo de Morto"
...
L["Use Modifier for Item Count"] = "Usar Modificador para Contador de Itens"
...
L["Use the profile specific filter Aura Indicator (Profile) instead of the global filter Aura Indicator."] = "Usar filtro específico de perfil para o Indicador de Aura (Perfil) ao invés do filtro global Indicador de Aura."
L["Use thin borders on certain nameplate elements."] = "Usar bordas finas para certos elementos das placas de identificação."
...
L["Use Value Color"] = "Usar Cor de Valor"
L["Use Zone Names"] = "Usar Nome de Zonas"
L["Used as Raid Debuff Indicator"] = "Usado como Indicador de Penalidade de Raíde"
...
L["Whats New"] = "O que tem de Novo"
L["When disabled, the Chat Background color has to be set via Blizzards Chat Tabs Background setting."] = "Quando desabilitado, a cor do Fundo do Bate-papo tem que ser configurada através da configuração de Fundo de Bate-papo da Blizzard"
...
L["When this is enabled, Low Health Threshold colors will not be displayed while targeted."] = "Quando estiver habilitado, as cores do Limiar de Vida Baixa não vão ser exibidas quando estiver mirado."
...
L["Whisper"] = "Sussurro"
L["Whitelist"] = "Lista de Permissão"
...
L["Will display mana when main power is:"] = "Irá mostrar mana quando o poder principal for:"
L["Will show Buffs in the Debuff position when there are no Debuffs active, or vice versa."] = "Irá mostrar Bônus na posição de Penalidades quando não tiver Penalidades ativas, ou vice-versa."
...
L["Wrapped"] = "Embrulhado"
L["X-Offset"] = "Distância X"
L["XP Quest Percent"] = "Porcentagem de XP do Objetivo"
L["Y-Offset"] = "Distância Y"
L["Yell"] = "Gritar"
L["You are about to reset paging. Are you sure?"] = "Você está a prestes de restaurar a paginação. Você tem certeza?"
...
L["Zone Button"] = "Botão de Zona"
L["Zone Name"] = "Nome da Zona"
L["|cffFF3333This does not work in Instances or Garrisons!|r"] = "|cffFF3333Isto não funciona em Instâncias ou Guarnições!|r"
